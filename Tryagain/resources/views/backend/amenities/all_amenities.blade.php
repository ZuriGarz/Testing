...
@section('admin')
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                <a href="{{ route('add.Amenitie') }}" class="btn btn-info">Add Amenities Type</a>
            </ol>
        </nav>
                                ...
                                <tbody>
                                    @foreach ($amenities as $key => $item)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('edit.amenities',$item->id) }}" class="btn btn-success">Edit</a>
                                            <a href="{{ route('delete.amenitie',$item->id) }}" class="btn btn-warning" id="delete">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
